...
export function createCountdown({
  ...
  digitsPath = (d) => `./digits/${d}.webp`, // mapping a partir del dígito
...
.cd-pill{
  ...
  /* 👇 forma “panel” como la imagen */
  border-radius: calc(var(--k) * 16px); /* o usa var(--cd-pill-radius) si prefieres */
  padding-inline: calc(var(--k) * 16px);
  background: var(--cd-pill-color, rgba(255,255,255));
  ...
  /* opcional: para que se vea más “limpio” */
  overflow: hidden;
}
