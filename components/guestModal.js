...
`;
  ...
  form.addEventListener('submit', async (e)=>{
    ...
    try{
      await fetch("https://script.google.com/macros/s/AKfycby4rpsprlOvbzNlAJ1N2TQJch4ocBC-IXI0A92HSUpoOUGc4zEITBh9kf42LFPlSgfD/exec", { method:'POST', body: fd, mode:'no-cors' });
