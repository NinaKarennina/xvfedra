...
`;
  ...
  form.addEventListener('submit', async (e)=>{
    ...
    try{
      await fetch("https://script.google.com/macros/s/AKfycbxdFS8thPX_byxIuwB2FmO8jm1R6bSTERhxWzEBtmCnaE7BzbCJ213miUj1NZxC-XZnPw/exec", { method:'POST', body: fd, mode:'no-cors' });
