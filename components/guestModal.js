...
#guest-modal{
  ...
  linear-gradient(135deg, var(--frame1), var(--frame2) 45%, var(--frame3)) border-box;
...
`;
  ...
  <div id="guest-modal" role="dialog" aria-modal="true" aria-labelledby="guest-modal-title">
    ...
    <div class="gm-content">
      <form id="guest-form" novalidate>
        ...
        <p style="margin:0 0 12px 0;">Por favor ayúdanos a confirmar tu asistencia antes del 15 de febrero.</p>

        <div class="field">
          <label>¿Asistirás?</label>
          <div style="display:flex; gap:25px; align-items:center; margin-top:6px;">
  ...
  form.addEventListener('submit', async (e)=>{
    ...
    try{
      await fetch("https://script.google.com/macros/s/AKfycbxwsK_4uc32yTDDUpHJEyWkqnRRmEIE19NoiH7je1cM7vLi7Sx7f22Vzjjv1KgdZ8QK9w/exec", { method:'POST', body: fd, mode:'no-cors' });
